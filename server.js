...
app.get('/', (req, res)=>{
    let url = 'https://api.themoviedb.org/3/movie/677179?api_key=c99339665756c2e0556623029bc61d42';
    axios.get(url)
    .then(response => {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=c99339665756c2e0556623029bc61d42&query=${userMovieTitle}`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=c99339665756c2e0556623029bc61d42&language=en-US';
